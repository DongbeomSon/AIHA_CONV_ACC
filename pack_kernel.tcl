...
# set_property value          {512} [ipx::get_bus_parameters DATA_WIDTH -of_objects [ipx::get_bus_interfaces axi_wmst -of_objects [ipx::current_core]]]

# ipx::add_bus_parameter DATA_WIDTH [ipx::get_bus_interfaces axi_rmst -of_objects [ipx::current_core]]
# set_property value          {512} [ipx::get_bus_parameters DATA_WIDTH -of_objects [ipx::get_bus_interfaces axi_rmst -of_objects [ipx::current_core]]]
...
# package_xo -force -xo_path ../krnl_conv.xo -kernel_name krnl_conv -ctrl_protocol ap_ctrl_chain -ip_directory ./krnl_conv_ip -output_kernel_xml ./krnl_conv.xml
